...
public class ProximasReservasActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Cargar las reservas al iniciar la actividad
        loadReservas(usuarioId);
    }

    private void loadReservas(int usuarioId) {
        ApiService apiService = ApiClient.getClient().create(ApiService.class);
        // Llamada al método de la API para obtener las reservas (ya no filtramos solo las de hoy)
        Call<JsonObject> call = apiService.getReservasHoy(true); // ⚠️ Ya no es List<Reserva>, sino JsonObject.
